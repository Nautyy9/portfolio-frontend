...
function Footer() {
  return (
    <div className='w-full h-max sm:h-96 bg-[#f5e4bc] flex  text-[#171717]  shadow-lg z-50 p-2  footer'>
      <div className=" flex flex-col justify-between  w-full h-full border-2 lg:border-none border-[#171717] p-4 lg:py-0 lg:px-4">
        <div className="text-5xl flex flex-col w-full justify-center gap-y-14 sm:gap-x-32 text-[#171717] my-10  ">
          <div className="flex flex-col sm:pl-52">
            ...
            <div className="flex gap-x-4 sm:gap-x-20 lg:gap-x-32 items-center my-auto justify-center border-y-2 border-[#171717]">
      ...
      <div className="flex flex-col sm:flex-row justify-around items-center gap-y-5 sm:gap-y-2 sm:items-end font-medium mb-5 my-5">
        <div className="flex gap-x-10 text-2xl">
          <Link to='skills' spy={true} smooth={true} offset={-64} duration={1000} className='py-0.5 px-2 border-2 border-[#171717]'>Skills</Link>
          <Link to='work' spy={true} smooth={true} offset={-64} duration={1000} className='py-0.5 px-2 border-2 border-[#171717]'>Work</Link>
        </div>
        <Link to='home' spy={true} smooth={true} offset={-64} duration={1000} className='text-4xl border-y-2 border-[#171717] '>Nitin's Folio</Link>
        <div className="flex gap-x-10 text-2xl">
          <Link to='about' spy={true} smooth={true} offset={-64} duration={1000} className='py-0.5 px-2 border-2 border-[#171717]'>About Me</Link>
          <Link to='contact' spy={true} smooth={true} offset={-64} duration={1000} className='py-0.5 px-2 border-2 border-[#171717]'>Contact</Link>
        </div>
      </div>
    </div>
    </div>
