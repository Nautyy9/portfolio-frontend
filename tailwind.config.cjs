...
module.exports = {
  content: ["./src/**/*.{html,js,ts,tsx}", "./Components/**/*.{html,js,ts,tsx}", "./layers/**/*.{html,js,ts,tsx}"],
  theme: {
    extend: {
      screens: {
        'xss': '380px',
      ...
      boxShadow: {
        ...
        skills:  '0 4px 6px -1px rgb(0 0 0 / 0.4), 0 2px 4px -2px rgb(0 0 0 / 0.4), 0 -3px 5px -1px rgb(0 0 0 / 0.5), 0 -1px 3px -1px rgb(0 0 0 / 0.3)'
